...
import DealsDetailsModal from "./DealsDetailsModal";
...
const DealsTable = () => {
  ...
  return (
    <>
                      ...
                      {paginatedRows.map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell>
                              <span className={`alert-badge ${phaseClass}`}>
                                {row?.phase}
                              </span>
                            </TableCell>
                            ...
                            <TableCell>{row?.chances}</TableCell>
                            <TableCell>
      ...
      {detailsModalOpen && editData?.dealAmount && (
        <DealsDetailsModal
